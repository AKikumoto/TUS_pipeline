...
# ==============================================================================
SITE_CONFIG = Path(__file__).parent.parent / "config" / "sites" / "site_RIKEN_AK.yaml"
...
# # GLOBAL SCREEN SETTINGS FOR WORKBENCH
...
# -IFJ / FEF
# -dIg_L_OR_dIg_R
targetLabel = "aMCC_NeuroSynthTopic112"
targetside  = '_R' # _L/_R/(empty)
additional_offset_s = 0 # Check per experiment and per subject (assumed offset from exit plane → skin)
...
#==============================================================================
# Transducer-specific variables — loaded from config (CTX-500 4CH, 500 kHz)
# Source: config/transducers/CTX500_RIKEN.yaml
#==============================================================================
...
plane_offset        = t_cfg["plane_offset_mm"]          # radiating surface → exit plane
